...
public final class CameraQuaternion
{
	...
	public CameraQuaternion(boolean vbm)
	{
		viewByMouse = vbm;
	}
	...
	public final void move(float speed)
	{
		...
		vVector = VectorMath.subtract(m_vView, m_vPosition);
	...
	private final void mouse_view()
	{
		...
		else
		{
			...
			vAxis = VectorMath.cross_product(VectorMath.subtract(m_vView, m_vPosition), m_vUpVector);
			VectorMath.normalize(vAxis);
